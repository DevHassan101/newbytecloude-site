...
export default function AboutSection() {
    ...
    return (
        <>
            <section className={`${styles.aboutBanner} py-28 px-6 lg:px-12 md:px-0`}>
            ...
            <section className="main-about-section bg-black relative pt-18 md:pt-26 pb-22 px-6 md:px-28 overflow-hidden">
                {/* light1:center-glow */}
