...
export default function ServiceDetailContent({ service }: ServiceDetailContentProps) {
    ...
    return (
        <div className="services-detail-section min-h-screen">
            <section className={`${styles.portfolioBanner} py-28 px-12 md:px-0 relative overflow-hidden`}>
                ...
                <div className="relative text-center mt-6 max-w-5xl mx-auto">
                    <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[18px] py-9 md:px-20.5 shadow-2xl relative overflow-hidden">
                        {/* Top accent line */}
                        ...
                        <div className="relative z-10">
                            <h1 className="text-[28px] md:text-6xl lg:text-[44px] font-bold mb-4 lg:mb-4 text-white">
                                {service.shortTitle}
                            </h1>
