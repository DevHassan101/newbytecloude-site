...
export default function ServiceDetailContent({ service }: ServiceDetailContentProps) {
    ...
    return (
        <div className="services-detail-section min-h-screen">
            <section className={`${styles.portfolioBanner} py-28 px-5 lg:px-12 relative overflow-hidden`}>
                  ...
                  viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.6, ease: [0.25, 0.1, 0.25, 1] }}>
                    <div className="border border-white/20 rounded-[18px] py-8 lg:py-10 md:px-20.5 shadow-2xl relative overflow-hidden"
                        ...
                        <div className="relative z-10 px-6">
                            <motion.h1 className="text-[22px] md:text-6xl lg:text-[44px] font-bold mb-1 lg:mb-3 text-white" initial={{ opacity: 0 }}
                              whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
                               {service.shortTitle}
                            </motion.h1>
                            <motion.p className="text-xs lg:text-[17px] text-white/90 leading-relaxed font-light line-clamp-3" initial={{ opacity: 0 }}
