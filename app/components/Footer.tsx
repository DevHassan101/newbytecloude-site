            ...
            <div className="footer-top relative h-75 bg-black rounded-4xl border border-white/10 overflow-hidden">
              ...
              <div className="footer-box1 absolute inset-0 flex">
                ...
                <div className="basis-[50%] relative h-full">
                  <img
                    src="/images/about/footimage.webp"
                    alt="Tech background"
              ...
              <div className="absolute inset-0 bg-linear-to-r from-[#0188fc] via-[#3bbbfc]/80 to-transparent rounded-4xl">
                <div
                  className="absolute inset-0 opacity-22 w-200"
                  style={{
                    backgroundImage:
                      "linear-gradient(#3bbbfc 1px, transparent 1px), linear-gradient(90deg, #3bbbfc 1px, transparent 1px)",
                ...
                <div className="relative flex justify-start items-center gap-55 px-20 w-full h-full">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex relative justify-start items-center gap-4">
                        ...
                        <span className="bg-black w-16 h-16 rounded-full flex justify-center items-center relative group cursor-pointer transition-all duration-300 hover:scale-110">
                          ...
                          <Icon
                            icon="lineicons:arrow-angular-top-right"
                            width="25"
                            height="25"
                            style={{ color: "#fff" }}
                          />
                  ...
                  <div className="content-2 ">
                    <div className="relative flex items-center justify-center">
                      ...
                      {/* The Badge Container */}
                      <div
                        className="group relative flex items-center overflow-hidden justify-center w-40 h-40 rounded-full
                      ...
                      >
                        ...
                        <div
                          className="absolute inset-0 rounded-full bg-linear-to-tr from-transparent via-white/20 to-transparent 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-0 md:space-y-6">
              ...
              <p className="text-sm md:text-base text-white/80 leading-relaxed text-justify tracking-tight pt-5 md:pt-0">
                ...
                innovation, built for performance, we are here to elevate your
                digital presence.
              </p>
              <div className="flex gap-3 mt-7 md:mt-0">
                ...
                <Link
                  href="https://www.facebook.com/profile.php?id=61589863101278"
                  target="_blank"
                  className="w-9 h-9 md:w-11 md:h-11 bg-linear-to-br from-[#3bbbfc] to-[#0188fc] rounded-full flex items-center justify-center border border-[#18a2e8] hover:scale-110 transition-transform duration-300"
                ...
                >
                  <svg
                    ...
                    className="jam jam-fiverr text-white w-5 h-[20px]"
                  >
              ...
              <ul className="space-y-3">
                ...
                //   { title: "Testimonial", link: "testimonials" },
                  ...
                  <li key={link.title}>
                    <a
                      href={link.link}
                      className="text-sm md:text-base text-white/80 hover:text-[#5cc9ff] transition-colors duration-300 flex items-center gap-2 group"
                    >
                      <Icon
                        icon="ph:arrow-right"
                        className="text-[#3bbbfc] group-hover:translate-x-1 transition-transform duration-300"
                      />
                      {link.title}
                    </a>
                  </li>
            ...
            <div className="ml-0 md:-ml-5">
              ...
              <ul className="space-y-5">
                <li>
                  <a
                    href="tel:+923455326164"
                    className="text-white/80 hover:text-[#5cc9ff] transition-colors duration-300 flex items-start gap-3 group"
                  >
                    <div className="w-9 h-9 md:w-10 md:h-10 bg-linear-to-br from-[#3bbbfc] to-[#0188fc] rounded-md md:rounded-lg flex items-center justify-center group-hover:bg-linear-to-br group-hover:from-[#3bbbfc] group-hover:to-[#5cc9ff] transition-all duration-300">
                      <Icon
                        icon="ri:phone-fill"
                        className="text-white group-hover:text-white text-md md:text-lg"
                      />
                    </div>
                    <span className="pt-2 text-[15px] md:text-base">
                      +92 345 5326164
                    </span>
                  </a>
                </li>
                <li>
                  ...
                  >
                    ...
                    <span className="pt-2 text-[15px] md:text-base">
                      Latifabad No.4 Hyderabad, Sindh
                    </span>
                  </a>
                </li>
                <li>
                  <a
                    href="mailto:bytecloude50@gmail.com"
                    className="text-white/80 hover:text-[#5cc9ff] transition-colors duration-300 flex items-start gap-3 group"
                  >
                    <div className="w-9 h-9 md:w-10 md:h-10 bg-linear-to-br from-[#3bbbfc] to-[#0188fc] rounded-md md:rounded-lg flex items-center justify-center group-hover:bg-linear-to-br group-hover:from-[#3bbbfc] group-hover:to-[#5cc9ff] transition-all duration-300">
                      <Icon
                    ...
                    <span className="pt-2 text-[15px] md:text-base break-all">
                      devhassan101@gmail.com
                    </span>
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <p className="text-[15px] md:text-base text-white/80 mb-4">
              ...
              <label className="flex items-start gap-2 mt-5 md:mt-4 text-[13px] md:text-sm text-white/80 cursor-pointer group">
                <input
                  type="checkbox"
                  className="mt-0 md:mt-1 accent-[#3bbbfc]"
                />
                <span className="group-hover:text-gray-300 transition-colors duration-300">
                  I agree to the{" "}
                  <a href="privacy-policy" className="text-[#5cc9ff] hover:underline">
                    Privacy Policy
                  </a>
                </span>
              </label>
          ...
          <div className="pt-8 text-center md:text-left">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-white/80 text-base md:text-[15px]">
                @Copyright 2025{" "}
                <span className="text-[#3bbbfc]">ByteCloude.</span> All Rights
                Reserved
              </p>
              <div className="flex gap-6 text-base md:text-[15px]">
                <a
                  href="terms-and-conditions"
                  className="text-white/80  hover:text-[#5cc9ff] transition-colors duration-300"
                >
