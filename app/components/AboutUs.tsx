            ...
            <div className="about-section flex flex-wrap justify-between items-center relative z-10">
                <div className="about-left basis-full lg:basis-[56%]">
                    <div className="about-content">
                        <div className="about-title" data-aos="fade-right" data-aos-duration="700">
                        ...
                        <div className="about-desc mt-5 md:mt-5" data-aos="fade-right" data-aos-delay="200" data-aos-duration="700">
                            ...
                            <div className="about-info grid grid-cols-2 gap-y-8 gap-x-4 mt-10 md:mt-12">
                                {[
                                    ...
                                    <div className="services-info" key={item.id} data-aos="zoom-in-up" data-aos-delay={300 + (index * 100)} data-aos-duration="600">
                                        <div className="flex items-center group cursor-default hover:translate-x-1 transition-transform duration-300">
                            ...
                            <div className="about-bars w-full md:max-w-120 space-y-8 md:space-y-10 mt-10 md:mt-12">
                                {skillData.map((skill, index) => (
                                    <div key={index} className="group" data-aos="fade-right" data-aos-delay="500" data-aos-duration="700">
                                        ...
                                        <div className="relative w-full h-2 md:h-2.5 bg-white/5 rounded-full overflow-hidden border border-white/10 backdrop-blur-sm">
                                            <motion.div className="h-full rounded-full relative"
                                                style={{ background: "linear-gradient(90deg, #3bbbfc 0%, #01a8fc 100%)", boxShadow: "0 0 20px rgba(59, 188, 252, 0.6)" }}
                                                initial={{ width: "0%" }}
                ...
                <div className="about-right basis-full lg:basis-[44%] mt-14 md:mt-0">
                    <div className="about-content relative">
                        <div data-aos="fade-left" data-aos-duration="800" className="about-image relative w-full h-55 md:h-86 flex flex-col 
                          justify-center items-center group overflow-hidden rounded-[10px] md:rounded-2xl">
                            <Image src="/images/about/aboutimage1.webp" alt="AboutUsOurTeam" fill sizes="(max-width: 768px) 100vw, 44vw"
                              quality={75} loading="lazy" className="w-full object-cover transition-all duration-500 ease-out group-hover:scale-110"/>
                            <div className="image-overlay absolute top-0 right-0 w-full h-full transition-all duration-500 ease-out"
                              style={{ backgroundImage: "linear-gradient(-125deg, rgba(59, 188, 252, 0.600), transparent)" }} />
                        </div>
                        <div data-aos="zoom-in" data-aos-delay="400" data-aos-duration="600" className="absolute top-45 md:-top-5 right-30 md:-left-10 w-20 h-20 md:w-30 md:h-30 rounded-xl md:rounded-3xl bg-linear-to-br from-[#3bbbfc] via-[#01a8fc] to-[#0086cc] flex flex-col justify-center items-center z-20 border border-white/40 
                            backdrop-blur-md cursor-pointer transition-all duration-500 hover:scale-110 group shadow-2xl overflow-hidden" style={{ boxShadow: "0 20px 40px -10px rgba(1, 168, 252, 0.5)" }}>
                        ...
                        <div className="images-box relative flex flex-wrap justify-between items-start md:items-center mt-1.5 md:mt-2.5">
                            ...
                            <div data-aos="fade-up" data-aos-delay="750" data-aos-duration="700" className="about-image basis-[49%] h-40 md:h-60 relative group/img 
                              overflow-hidden rounded-[10px] md:rounded-2xl shadow-lg transition-all duration-500">
                                <Image src="/images/about/aboutimage3.webp" alt="AboutUsOwner" fill sizes="(max-width: 768px) 49vw, 22vw" 
                                  quality={75} loading="lazy" className="w-full object-cover transition-all duration-500 ease-out group-hover/img:scale-110" />
                                <div className="image-overlay absolute top-0 right-0 w-full h-full transition-all duration-500 ease-out group-hover/img:opacity-80"
                                  style={{ backgroundImage: "linear-gradient(-125deg, rgba(59, 188, 252, 0.600), transparent)" }}/>
